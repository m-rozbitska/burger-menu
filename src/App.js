        ...
        <div className="container">
          <div className="header__body">
            <a href="#" className="header__logo">
              <img className="logo__img" src={logo} alt="Retromagaz" />
            </a>
            ...
            <div className="header__leftside">
              ...
              <a href="#" className="cart__link">
                ...
                >
                  <path
                    d="M14 15.125H30.1803L28.4344 24.5H15.3525L14 15.125ZM14 15.125L13.6311 11.2442L9.5 9.5"
                    stroke="white"
                    stroke-width="2"
                  ></path>
          ...
          >
            <div className="list__header">
              <a href="#" className="list__header-title">
                Retromagaz
              </a>
              <button className="close__btn" onClick={toggleMenu}>
                &times;
              </button>
            </div>
                ...
                <div className="menu__block">
                  ...
                  <div className="list__info">
                    <li className="info__item">
                      <a href="" className="info__link">
                        ...
                        >
                          ...
                          ></circle>
                          <path
                            d="M29 31C29 23.8203 23.1797 18 16 18C8.8203 18 3 23.8203 3 31"
                            stroke="#C4C4C4"
                            stroke-width="3"
                          ></path>
                        </svg>
                        <p className="info__text">Особистий кабінет</p>
                      </a>
                    </li>
                    <li className="info__item">
                      <a href="" className="info__link">
                        <svg
                          className="side-menu__cart-icon"
                          width="26"
                          height="24"
                          viewBox="0 0 26 24"
                          fill="none"
                        ...
                        >
                          <path
                            d="M6 7.125H22.1803L20.4344 16.5H7.35246L6 7.125ZM6 7.125L5.63115 3.24419L1.5 1.5"
                            stroke="#C4C4C4"
                            stroke-width="2"
                          ></path>
                          <circle
                    ...
                    <li className="info__item">
                      <a href="" className="info__link">
                        <svg
                          className="side-menu__favorite-icon"
                          width="26"
                          height="24"
                          viewBox="0 0 26 24"
                          fill="none"
                  ...
                  <div className="list__media">
                    ...
                    <div className="media__block">
                      <a
                        target="_blank"
                        rel="noopener"
                        href="https://www.instagram.com/retromagaz/"
                      ...
                      <a
                        target="_blank"
                        rel="noopener"
                        href="https://www.tiktok.com/@retromagaz?"
                      ...
                      <a
                        target="_blank"
                        rel="noopener"
                        href="https://www.facebook.com/retromagaz"
                    ...
                    <span className="media__info">
                      10:00 - 21:00 без вихідних
                    </span>
                    <p className="media__title">Телефони</p>
                    <a href="" className="media__phone">
                      0 800 33 41 45
                    </a>
                    <p className="media__title">Магазини</p>
                    <p className="media__info">Київ, вул. Івана Франка, 42</p>
                    <p className="media__info">
                      Київ, проспект Степана Бандери, 16/6
                    </p>
                    <p className="media__info">
                      Львів, вул. Ігоря Білозіра, 8 (колишня Герцена,8)
                    </p>
                    <p className="media__info">
                      Одеса, вул. Мала Арнаутська, 44
                    </p>
                  </div>
                  <hr className="solid" />
                  <div className="list__language">
                    <a href="" className="language__link link__active">
                      УКР
                    </a>
